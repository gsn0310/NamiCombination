<template>
    <div class="app2">
      ...
      <!--底部重置密码-->
      <div class="sub"><router-link :to="{path:'/submit'}" style="color: dodgerblue">重置密码？</router-link></div>
      <!--点击登录弹出提示框-->
...
// }
          ...
          this.myaxios.post("https://elm.cangdu.org/v2/login",{username:this.username,password:this.psd,captcha_code:this.yzm},(res)=>{
            console.log(res);
            //判断验证码是否输入正确
            if(res.status==0){
              this.hiddens=true
